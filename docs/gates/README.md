...
> - 下一步：第 1、2、3 施工關已完成；第 4、5、11（畫面層）施工關已 merge、使用者追認與親自驗收皆通過，實作中；第 6 施工關開工前提案已 merge、確認完畢，實作中。
...
| 4 | [`holder`](gate-04-holder.md) | agend-holder | 實作中（2026-09-26） | `cargo xtask accept holder` |
| 5 | [`store`](gate-05-store.md) | agend-daemon：store | 實作中（2026-09-26） | `cargo xtask accept store` |
...
| 11 | [`tui`](gate-11-tui.md) | agend-tui | 實作中，畫面層完成（2026-09-26） | `cargo xtask accept tui` |
