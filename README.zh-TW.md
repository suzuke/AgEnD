...
協作 MCP tools：`list_instances`、`send_to_instance`、`start_instance`、`create_instance`
...
- `create_instance` — 從專案目錄建立新 instance 和 Telegram topic
...
既有的斜線指令（`/open`、`/new`、`/meets`、`/status` 等）與 General instance 並存，繼續運作。
