...
//! demo. For gate 11 run the per-crate checks, check-deps, then the TUI demo
//! (screens, navigation, resolve, disconnect against the testkit fake
//! daemon). Other gates use the current per-crate checks until their
