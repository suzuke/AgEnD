...
fn strings(text: Text) -> (&'static str, &'static str) {
    ...
    match text {
        ...
        HelpHome => (
            "↑↓ move · →/Enter open · t terminal · ! needs you · / find · {} · q quit",
            "↑↓ 移動 · →/Enter 開啟 · t 終端 · ! 需要你 · / 搜尋 · {} · q 離開",
        ),
        HelpNeedsYou => (
            "↑↓ move · →/Enter choose · 1-9 option · a answer · t terminal · ←/Esc back · {}",
            "↑↓ 移動 · →/Enter 選擇 · 1-9 選項 · a 回答 · t 終端 · ←/Esc 返回 · {}",
        ),
        HelpTeam => (
            "1/2/3 or Tab tabs · ↑↓ move · →/Enter open · t terminal · ←/Esc back · {}",
            "1/2/3 或 Tab 切換分頁 · ↑↓ 移動 · →/Enter 開啟 · t 終端 · ←/Esc 返回 · {}",
        ),
        HelpDetail => (
            "↑↓ move · →/Enter open · t terminal · ←/Esc back · h home · / find · {}",
            "↑↓ 移動 · →/Enter 開啟 · t 終端 · ←/Esc 返回 · h 首頁 · / 搜尋 · {}",
        ),
        HelpTerminal => (
            "↑↓ scroll · ←/Esc back · h home · {} · q quit",
            "↑↓ 捲動 · ←/Esc 返回 · h 首頁 · {} · q 離開",
        ),
        HelpFinder => (
