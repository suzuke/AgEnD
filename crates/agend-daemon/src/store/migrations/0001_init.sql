-- 0001_init (gate 5 P3): the three tables that have users today. Later gates
-- add their own tables in their own migrations; never edit this file once it
-- has shipped (tests compare every old version's fixture with golden/schema.sql).
